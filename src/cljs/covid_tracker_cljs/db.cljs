...
(def app-db
  {:background-color 50
   :shapes {:Ahvenanmaa {:points [:g6 :h6 :i6 :j6 :k6]
                         ...
                         :statistics {:deaths 1
                                      :infections 12}
                         :municipalities {:Ahvenanmaa {:statistics {:deaths 1
                                                                    :infections 10}}}}
            :Etelä-Karjala {:points [:d2 :c3 :h3 :i3 :d3 :e3 :f3 :g3 :j2 :i2 :h2 :g2 :c2]
                            ...
                            :statistics {:deaths 1
                                         :infections 12}
                            :municipalities {:Lappeenranta {:statistics {:deaths 1
                                                                       :infections 10}}}}
            :Etelä-Pohjanmaa {:points [:m5 :i5 :z2 :w2 :v2 :h5 :d5 :e5 :f5 :u5 :t5 :s5 :r5 :q5 :p5 :o5]
                              ...
                              :statistics {:deaths 1
                                           :infections 12}
                              :municipalities {:Seinäjoki {:statistics {:deaths 1
                                                                         :infections 10}}}}
            :Etelä-Savo {:points [:u1 :t1 :s1 :r1 :a2 :b2 :c2 :g2 :h2 :i2 :j2 :k2 :l2 :m2 :n2 :o2 :v1]
                         :offset [100 110]
                         :scale 1
                         :statistics {:deaths 1
                                      :infections 12}
                         :municipalities {:Mikkeli {:statistics {:deaths 1
                                                                    :infections 10}}}}
            :Lappi {:points [:m6 :c :d :e :f :n6 :g :h :i :j :k :l :m :n :o :p :o6]
                    ...
                    :statistics {:deaths 4
                                 :infections 89}
                    :municipalities {:Rovaniemi {:statistics {:deaths 3
                                                              :infections 55}}
                                     :Tornio {:statistics {:deaths 1
                                                         :infections 20}}}}
            :Kainuu {:points [:r :e1 :f1 :g1 :h1 :i1 :j1 :k1 :l1 :m1 :u :t :s]
                     ...
                     :statistics {:deaths 1
                                  :infections 12}
                     :municipalities {:Kajaani {:statistics {:deaths 1
                                                                :infections 10}}}}
            :Kanta-Häme {:points [:u3 :t3 :s3 :z3 :a4 :l4 :m4 :o4 :p4]
                         ...
                         :statistics {:deaths 1
                                      :infections 12}
                         :municipalities {:Hämeenlinna {:statistics {:deaths 1
                                                                    :infections 10}}}}
            :Keski-Pohjanmaa {:points [:a1 :b1 :z :b3 :z2 :i5 :j5 :k5 :l5]
                              ...
                              :statistics {:deaths 1
                                           :infections 12}
                              :municipalities {:Kokkola {:statistics {:deaths 1
                                                                         :infections 10}}}}
            ...
            :Kymenlaakso {:points [:l2 :k2 :j2 :g3 :f3 :e3 :j3 :k3 :l3 :m3 :n3 :o3 :q3]
                          ...
                          :statistics {:deaths 1
                                       :infections 12}
                          :municipalities {:Kouvola {:statistics {:deaths 1
                                                                     :infections 10}}}}
            :Päijät-Häme {:points [:p2 :m2 :l2 :q3 :o3 :n3 :p3 :s3 :t3 :u3 :v3 :w3 :q2]
                          ...
                          :statistics {:deaths 1
                                       :infections 12}
                          :municipalities {:Lahti {:statistics {:deaths 1
                                                                     :infections 10}}}}
            :Pirkanmaa {:points [:h5 :v2 :u2 :t2 :q2 :w3 :v3 :u3 :p4 :o4 :m4 :n4 :v4 :w4 :z4 :a5 :b5 :d5]
                        ...
                        :statistics {:deaths 1
                                     :infections 12}
                        :municipalities {:Tampere {:statistics {:deaths 1
                                                                   :infections 10}}}}
            :Pohjanmaa {:points [:l5 :k5 :j5 :i5 :m5 :o5 :p5 :q5 :r5 :s5 :t5 :u5 :g5 :d6 :c6 :b6 :a6 :z5 :w5]
                        ...
                        :statistics {:deaths 1
                                     :infections 12}
                        :municipalities {:Vaasa {:statistics {:deaths 1
                                                                   :infections 10}}}}
            :Pohjois-Karjala {:points [:m1 :l1 :k1 :j1 :f2 :e2 :d2 :c2 :b2 :a2 :r1 :q1 :p1 :o1 :n1]
                              ...
                              :statistics {:deaths 1
                                           :infections 12}
                              :municipalities {:Joensuu {:statistics {:deaths 1
                                                                         :infections 10}}}}
            :Pohjois-Pohjanmaa {:points [:m :l :k :q :r :s :t :u :v :w :b3 :z :b1 :a1 :c1 :d1]
                                ...
                                :statistics {:deaths 1
                                             :infections 12}
                                :municipalities {:Oulu {:statistics {:deaths 1
                                                                           :infections 10}}}}
            :Pohjois-Savo {:points [:u :m1 :n1 :o1 :p1 :q1 :r1 :s1 :t1 :u1 :v1 :w1 :z1 :v]
                           ...
                           :statistics {:deaths 1
                                        :infections 12}
                           :municipalities {:Kuopio {:statistics {:deaths 1
                                                                      :infections 10}}}}
            :Satakunta {:points [:d5 :b5 :a5 :z4 :w4 :v4 :u4 :t4 :f6 :e6 :g5 :u5 :f5 :e5]
                        ...
                        :statistics {:deaths 1
                                     :infections 12}
                        :municipalities {:Pori {:statistics {:deaths 1
                                                                   :infections 10}}}}
            ...
            :Varsinais-Suomi {:points [:t4 :u4 :v4 :n4 :m4 :l4 :a4 :b4 :c4 :d4 :q4 :r4 :s4]
                              ...
                              :statistics {:deaths 1
                                           :infections 12}
                              :municipalities {:Turku {:statistics {:deaths 1
                                                                         :infections 10}}}}}
