...
(def app-db
  {:shapes {:Ahvenanmaa {:points [:g6 :h6 :i6 :j6 :k6]
                         :offset [20 200]
                         :scale 1}
            :Etelä-Karjala {:points [:d2 :c3 :h3 :i3 :d3 :e3 :f3 :g3 :j2 :i2 :h2 :g2 :c2]
                            :offset [130 165]
                            :scale 1}
            :Etelä-Pohjanmaa {:points [:m5 :i5 :z2 :w2 :v2 :h5 :d5 :e5 :f5 :u5 :t5 :s5 :r5 :q5 :p5 :o5]
                              :offset [58 140]
                              :scale 1}
            :Etelä-Savo {:points [:u1 :t1 :s1 :q6 :h2 :i2 :j2 :k2 :l2 :m2 :n2 :o2 :v1]
                         :offset [100 110]
                         :scale 1}

            :Itä-Savo {:points [:a2 :b2 :c2 :g2 :h2 :q6 :s1 :r1]
                       :offset [120 120]
                       :scale 1}
            :Kaikki {:points [:m1 :l1 :k1 :j1]
                     :offset [0 0]
                     :scale 1}
            :Kainuu {:points [:r :e1 :f1 :g1 :h1 :i1 :j1 :k1 :l1 :m1 :u :t :s]
                     :offset [100 27]
                     :scale 1}
            :Kanta-Häme {:points [:u3 :t3 :s3 :z3 :a4 :l4 :m4 :o4 :p4]
                         :offset [40 210]
                         :scale 1}
            ...
            :Kymenlaakso {:points [:l2 :k2 :j2 :g3 :f3 :e3 :j3 :k3 :l3 :m3 :n3 :o3 :q3]
                          :offset [90 160]
                          :scale 1}
            :Lappi {:points [:m6 :c :d :e :f :n6 :g :h :i :j :k :l :p6 :j4 :f4 :a3 :o :p :o6]
                    :offset [100 0]
                    :scale 1}
            :Länsi-Pohja {:points [:a3 :f4 :j4 :p6 :m :n :o]
                          :offset [-50 0]
                          :scale 1}
            ...
            :Pohjois-Savo {:points [:u :m1 :n1 :o1 :p1 :q1 :r1 :s1 :t1 :u1 :v1 :w1 :z1 :v]
                           :offset [120 60]
                           :scale 1}
            :Päijät-Häme {:points [:p2 :m2 :l2 :q3 :o3 :n3 :p3 :s3 :t3 :u3 :v3 :w3 :q2]
                          :offset [60 190]
                          :scale 1}
   ...
   :map-dots {:a [0 670] :b [400 670] :c [117 46] :d [155 89] :e [198 96] :f [238 11] :g [298 33]
              ...
              :o [166 226] :p [163 154] :q [332 279] :r [321 296] :s [257 324] :t [259 361] :u [243 391]
              ...
              :a3 [196 215] :b3 [191 426] :c3 [325 554] :d3 [294 589] :e3 [279 607] :f3 [263 600] :g3 [253 590]
              :h3 [303 581]  :i3 [300 590] :j3 [270 619] :k3 [253 615] :l3 [237 623] :m3 [234 614] :n3 [226 602]
              :o3 [234 593] :p3 [212 604] :q3 [225 580] :r3 [200 599] :s3 [189 598] :t3 [193 577] :u3 [184 566]
              :v3 [183 556] :w3 [198 555] :z3 [173 608] :a4 [150 607] :b4 [143 619] :c4 [140 635] :d4 [121 641]
              :e4 [118 658] :f4 [192 242] :g4 [163 644] :h4 [166 649] :i4 [181 638] :j4 [222 255] :l4 [137 600]
              :m4 [126 591] :n4 [128 583] :o4 [149 586]  :p4 [163 570] :q4 [97 643] :r4 [73 635] :s4 [69 609]
              :t4 [73 577] :u4 [93 588] :v4 [122 580] :w4 [113 566] :z4 [107 550] :a5 [117 539] :b5 [113 518]
              :d5 [123 501] :e5 [103 510] :f5 [96 517] :g5 [76 517] :h5 [138 493] :i5 [152 431] :j5 [150 419]
              :k5 [149 406] :l5 [133 402] :m5 [143 423] :o5 [119 436] :p5 [121 447] :q5 [107 450] :r5 [108 467]
              :s5 [94 461] :t5 [88 476] :u5 [86 514] :w5 [120 410] :z5 [110 422] :a6 [101 433] :b6 [89 436]
              :c6 [82 458] :d6 [73 472] :e6 [84 542]  :f6 [77 562] :g6 [37 629] :h6 [27 640] :i6 [13 632]
              :j6 [11 616] :k6 [33 617] :m6 [99 59] :n6 [268 0] :o6 [144 105] :p6 [226 276] :q6 [288 513]}})
